...
export default function NewPostPage() {
  ...
  // 2. Handle image upload to Supabase Storage
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Upload file to bucket 'post-thumbnails'
    ...
    <div className="py-6 space-y-6 max-w-4xl mx-auto w-full animate-fade-in">
      ...
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Soạn thảo nội dung hấp dẫn, thiết lập đường dẫn, phân loại thẻ và tải lên ảnh thu nhỏ
        </p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6 glass p-6 rounded-2xl border border-border/40 bg-card/25 shadow-xl">
          ...
          <div>
            ...
            <p className="text-[10px] text-muted-foreground mt-1">
              Được dùng làm đường dẫn hiển thị: https://yoursite.com/<strong>{slug || "slug-placeholder"}</strong>
            </p>
          </div>
            ...
            {thumbnailUrl ? (
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-1 text-xs text-green-500 font-semibold">
                  ...
                  <span>Tải ảnh thu nhỏ thành công!</span>
                </div>
                <button
                  type="button"
          ...
          <div className="glass p-6 rounded-2xl border border-border/40 bg-card/25 shadow-xl space-y-4">
            ...
            <div>
              ...
              <p className="text-[9px] text-muted-foreground mt-1.5 leading-relaxed">
                Nhập các từ khóa phân tách bằng dấu phẩy. Hệ thống sẽ tự động thêm và liên kết thẻ trong cơ sở dữ liệu.
              </p>
            </div>
          </div>
        </div>
